...
@ /home/student/seng440/filter/butterworth_unrolled4.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled4.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:36:         register int input0 = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp222, x
	add	r3, r3, r2	@ _3, tmp222
@ /home/student/seng440/filter/butterworth_unrolled4.c:36:         register int input0 = x[i];
	ldr	r1, [r3]	@ input0, *_3
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:43:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled4.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled4.c:45:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled4.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp225, x
	add	r3, r3, r2	@ _22, tmp225
@ /home/student/seng440/filter/butterworth_unrolled4.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:56:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled4.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled4.c:58:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled4.c:62:         register int input2 = x[i + 2];
	...
	ldr	r2, [r7, #4]	@ tmp228, x
	add	r3, r3, r2	@ _41, tmp228
@ /home/student/seng440/filter/butterworth_unrolled4.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:69:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled4.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled4.c:71:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled4.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp231, x
	add	r3, r3, r2	@ _60, tmp231
@ /home/student/seng440/filter/butterworth_unrolled4.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:82:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled4.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled4.c:84:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled4.c:34:     for (i = 0; i + 3 < sample_count; i += 4) {
	add	r8, r8, #4	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled4.c:34:     for (i = 0; i + 3 < sample_count; i += 4) {
	add	r3, r8, #3	@ _76, i,
@ /home/student/seng440/filter/butterworth_unrolled4.c:34:     for (i = 0; i + 3 < sample_count; i += 4) {
	ldr	r2, [r7]	@ tmp234, sample_count
	cmp	r2, r3	@ tmp234, _76
	bgt	.L5		@,
@ /home/student/seng440/filter/butterworth_unrolled4.c:89:     for (; i < sample_count; i++) {
	b	.L6		@
.L7:
@ /home/student/seng440/filter/butterworth_unrolled4.c:90:         register int current_input = x[i];
	mov	r3, r8	@ i.24_77, i
	lsls	r3, r3, #2	@ _78, i.24_77,
	ldr	r2, [r7, #4]	@ tmp235, x
	add	r3, r3, r2	@ _79, tmp235
@ /home/student/seng440/filter/butterworth_unrolled4.c:90:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_79
@ /home/student/seng440/filter/butterworth_unrolled4.c:91:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:92:         y = ((y) + (b02_1 * x2));
	movw	r3, #1105	@ b02_1.27_85,
	mul	r3, r3, r9	@ _86, b02_1.27_85, x2
@ /home/student/seng440/filter/butterworth_unrolled4.c:92:         y = ((y) + (b02_1 * x2));
	add	r4, r4, r3	@ y, _86
@ /home/student/seng440/filter/butterworth_unrolled4.c:93:         y = ((y) + (a1 * y1));
	movw	r3, #18727	@ a1.28_87,
	mul	r3, r5, r3	@ _88, y1, a1.28_87
@ /home/student/seng440/filter/butterworth_unrolled4.c:93:         y = ((y) + (a1 * y1));
	add	r4, r4, r3	@ y, _88
@ /home/student/seng440/filter/butterworth_unrolled4.c:94:         y = ((y) + (a2 * y2));
	movw	r3, #58773	@ a2.29_89,
	movt	r3, 65535	@ a2.29_89,
	mul	r3, r3, r10	@ _90, a2.29_89, y2
@ /home/student/seng440/filter/butterworth_unrolled4.c:94:         y = ((y) + (a2 * y2));
	add	r4, r4, r3	@ y, _90
@ /home/student/seng440/filter/butterworth_unrolled4.c:95:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	asrs	r3, r4, #14	@ _91, y,
@ /home/student/seng440/filter/butterworth_unrolled4.c:95:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:97:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled4.c:98:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled4.c:99:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:100:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled4.c:89:     for (; i < sample_count; i++) {
	add	r8, r8, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled4.c:89:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp238, sample_count
	cmp	r8, r3	@ i, tmp238
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled4.c:103:     return y1;
	mov	r3, r5	@ _112, y1
@ /home/student/seng440/filter/butterworth_unrolled4.c:104: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:131:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled4.c:134:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled4.c:136:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled4.c:149:     return 0;
	movs	r3, #0	@ _17,
.L15:
