...
@ /home/student/seng440/filter/butterworth_unrolled10.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled10.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:36:         register int input0 = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp342, x
	add	r3, r3, r2	@ _3, tmp342
@ /home/student/seng440/filter/butterworth_unrolled10.c:36:         register int input0 = x[i];
	ldr	r1, [r3]	@ input0, *_3
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:43:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled10.c:45:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp345, x
	add	r3, r3, r2	@ _22, tmp345
@ /home/student/seng440/filter/butterworth_unrolled10.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:56:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled10.c:58:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:62:         register int input2 = x[i + 2];
	mov	r3, r10	@ i.12_38, i
	adds	r3, r3, #2	@ _39, i.12_38,
	lsls	r3, r3, #2	@ _40, _39,
	ldr	r2, [r7, #4]	@ tmp348, x
	add	r3, r3, r2	@ _41, tmp348
@ /home/student/seng440/filter/butterworth_unrolled10.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:69:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled10.c:71:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp351, x
	add	r3, r3, r2	@ _60, tmp351
@ /home/student/seng440/filter/butterworth_unrolled10.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:82:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled10.c:84:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:88:         register int input4 = x[i + 4];
	...
	ldr	r2, [r7, #4]	@ tmp354, x
	add	r3, r3, r2	@ _79, tmp354
@ /home/student/seng440/filter/butterworth_unrolled10.c:88:         register int input4 = x[i + 4];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:95:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:96:         x1 = input4;
	mov	r6, r1	@ x1, input4
@ /home/student/seng440/filter/butterworth_unrolled10.c:97:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:98:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:101:         register int input5 = x[i + 5];
	mov	r3, r10	@ i.30_95, i
	adds	r3, r3, #5	@ _96, i.30_95,
	lsls	r3, r3, #2	@ _97, _96,
	ldr	r2, [r7, #4]	@ tmp357, x
	add	r3, r3, r2	@ _98, tmp357
@ /home/student/seng440/filter/butterworth_unrolled10.c:101:         register int input5 = x[i + 5];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:108:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:109:         x1 = input5;
	mov	r6, r1	@ x1, input5
@ /home/student/seng440/filter/butterworth_unrolled10.c:110:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:111:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:114:         register int input6 = x[i + 6];
	...
	ldr	r2, [r7, #4]	@ tmp360, x
	add	r3, r3, r2	@ _117, tmp360
@ /home/student/seng440/filter/butterworth_unrolled10.c:114:         register int input6 = x[i + 6];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:121:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:122:         x1 = input6;
	mov	r6, r1	@ x1, input6
@ /home/student/seng440/filter/butterworth_unrolled10.c:123:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:124:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:127:         register int input7 = x[i + 7];
	...
	ldr	r2, [r7, #4]	@ tmp363, x
	add	r3, r3, r2	@ _136, tmp363
@ /home/student/seng440/filter/butterworth_unrolled10.c:127:         register int input7 = x[i + 7];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:134:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:135:         x1 = input7;
	mov	r6, r1	@ x1, input7
@ /home/student/seng440/filter/butterworth_unrolled10.c:136:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:137:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:139:         register int input8 = x[i + 8];
	...
	ldr	r2, [r7, #4]	@ tmp366, x
	add	r3, r3, r2	@ _155, tmp366
@ /home/student/seng440/filter/butterworth_unrolled10.c:139:         register int input8 = x[i + 8];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:146:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:147:         x1 = input8;
	mov	r6, r1	@ x1, input8
@ /home/student/seng440/filter/butterworth_unrolled10.c:148:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:149:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:151:         register int input9 = x[i + 9];
	...
	ldr	r2, [r7, #4]	@ tmp369, x
	add	r3, r3, r2	@ _174, tmp369
@ /home/student/seng440/filter/butterworth_unrolled10.c:151:         register int input9 = x[i + 9];
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:158:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:159:         x1 = input9;
	mov	r6, r1	@ x1, input9
@ /home/student/seng440/filter/butterworth_unrolled10.c:160:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:161:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:34:     for (i = 0; i + 9 < sample_count; i += 10) {
	add	r10, r10, #10	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled10.c:34:     for (i = 0; i + 9 < sample_count; i += 10) {
	add	r3, r10, #9	@ _190, i,
@ /home/student/seng440/filter/butterworth_unrolled10.c:34:     for (i = 0; i + 9 < sample_count; i += 10) {
	ldr	r2, [r7]	@ tmp372, sample_count
	cmp	r2, r3	@ tmp372, _190
	bgt	.L5		@,
@ /home/student/seng440/filter/butterworth_unrolled10.c:214:     for (; i < sample_count; i++) {
	b	.L6		@
.L7:
@ /home/student/seng440/filter/butterworth_unrolled10.c:215:         register int current_input = x[i];
	mov	r3, r10	@ i.60_191, i
	lsls	r3, r3, #2	@ _192, i.60_191,
	ldr	r2, [r7, #4]	@ tmp373, x
	add	r3, r3, r2	@ _193, tmp373
@ /home/student/seng440/filter/butterworth_unrolled10.c:215:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_193
@ /home/student/seng440/filter/butterworth_unrolled10.c:216:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
	movw	r3, #1105	@ b02_1.61_194,
	mul	r2, r3, r1	@ _195, b02_1.61_194, current_input
@ /home/student/seng440/filter/butterworth_unrolled10.c:216:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:217:         y = ((y) + (b02_1 * x2));
	movw	r3, #1105	@ b02_1.63_199,
	mul	r3, r3, r8	@ _200, b02_1.63_199, x2
@ /home/student/seng440/filter/butterworth_unrolled10.c:217:         y = ((y) + (b02_1 * x2));
	add	r4, r4, r3	@ y, _200
@ /home/student/seng440/filter/butterworth_unrolled10.c:218:         y = ((y) + (a1 * y1));
	movw	r3, #18727	@ a1.64_201,
	mul	r3, r5, r3	@ _202, y1, a1.64_201
@ /home/student/seng440/filter/butterworth_unrolled10.c:218:         y = ((y) + (a1 * y1));
	add	r4, r4, r3	@ y, _202
@ /home/student/seng440/filter/butterworth_unrolled10.c:219:         y = ((y) + (a2 * y2));
	movw	r3, #58773	@ a2.65_203,
	movt	r3, 65535	@ a2.65_203,
	mul	r3, r3, r9	@ _204, a2.65_203, y2
@ /home/student/seng440/filter/butterworth_unrolled10.c:219:         y = ((y) + (a2 * y2));
	add	r4, r4, r3	@ y, _204
@ /home/student/seng440/filter/butterworth_unrolled10.c:220:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:222:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled10.c:223:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled10.c:224:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:225:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled10.c:214:     for (; i < sample_count; i++) {
	add	r10, r10, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled10.c:214:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp376, sample_count
	cmp	r10, r3	@ i, tmp376
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled10.c:228:     return y1;
	mov	r3, r5	@ _226, y1
@ /home/student/seng440/filter/butterworth_unrolled10.c:229: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:256:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled10.c:259:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled10.c:261:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled10.c:274:     return 0;
	movs	r3, #0	@ _17,
.L15:
