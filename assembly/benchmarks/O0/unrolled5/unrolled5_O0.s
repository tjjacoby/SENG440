...
@ /home/student/seng440/filter/butterworth_unrolled5.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled5.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:43:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled5.c:45:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp245, x
	add	r3, r3, r2	@ _22, tmp245
@ /home/student/seng440/filter/butterworth_unrolled5.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:56:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled5.c:58:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:62:         register int input2 = x[i + 2];
	...
	ldr	r2, [r7, #4]	@ tmp248, x
	add	r3, r3, r2	@ _41, tmp248
@ /home/student/seng440/filter/butterworth_unrolled5.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:69:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled5.c:71:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp251, x
	add	r3, r3, r2	@ _60, tmp251
@ /home/student/seng440/filter/butterworth_unrolled5.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:82:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled5.c:84:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:88:         register int input4 = x[i + 4];
	...
	ldr	r2, [r7, #4]	@ tmp254, x
	add	r3, r3, r2	@ _79, tmp254
@ /home/student/seng440/filter/butterworth_unrolled5.c:88:         register int input4 = x[i + 4];
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:95:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:96:         x1 = input4;
	mov	r6, r1	@ x1, input4
@ /home/student/seng440/filter/butterworth_unrolled5.c:97:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:98:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:34:     for (i = 0; i + 4 < sample_count; i += 5) {
	add	r8, r8, #5	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled5.c:34:     for (i = 0; i + 4 < sample_count; i += 5) {
	add	r3, r8, #4	@ _95, i,
@ /home/student/seng440/filter/butterworth_unrolled5.c:34:     for (i = 0; i + 4 < sample_count; i += 5) {
	ldr	r2, [r7]	@ tmp257, sample_count
	cmp	r2, r3	@ tmp257, _95
	bgt	.L5		@,
@ /home/student/seng440/filter/butterworth_unrolled5.c:115:     for (; i < sample_count; i++) {
	b	.L6		@
.L7:
@ /home/student/seng440/filter/butterworth_unrolled5.c:116:         register int current_input = x[i];
	mov	r3, r8	@ i.30_96, i
	lsls	r3, r3, #2	@ _97, i.30_96,
	ldr	r2, [r7, #4]	@ tmp258, x
	add	r3, r3, r2	@ _98, tmp258
@ /home/student/seng440/filter/butterworth_unrolled5.c:116:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_98
@ /home/student/seng440/filter/butterworth_unrolled5.c:117:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
	movw	r3, #1105	@ b02_1.31_99,
	mul	r2, r3, r1	@ _100, b02_1.31_99, current_input
@ /home/student/seng440/filter/butterworth_unrolled5.c:117:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:118:         y = ((y) + (b02_1 * x2));
	movw	r3, #1105	@ b02_1.33_104,
	mul	r3, r3, r9	@ _105, b02_1.33_104, x2
@ /home/student/seng440/filter/butterworth_unrolled5.c:118:         y = ((y) + (b02_1 * x2));
	add	r4, r4, r3	@ y, _105
@ /home/student/seng440/filter/butterworth_unrolled5.c:119:         y = ((y) + (a1 * y1));
	movw	r3, #18727	@ a1.34_106,
	mul	r3, r5, r3	@ _107, y1, a1.34_106
@ /home/student/seng440/filter/butterworth_unrolled5.c:119:         y = ((y) + (a1 * y1));
	add	r4, r4, r3	@ y, _107
@ /home/student/seng440/filter/butterworth_unrolled5.c:120:         y = ((y) + (a2 * y2));
	movw	r3, #58773	@ a2.35_108,
	movt	r3, 65535	@ a2.35_108,
	mul	r3, r3, r10	@ _109, a2.35_108, y2
@ /home/student/seng440/filter/butterworth_unrolled5.c:120:         y = ((y) + (a2 * y2));
	add	r4, r4, r3	@ y, _109
@ /home/student/seng440/filter/butterworth_unrolled5.c:121:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:123:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled5.c:124:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled5.c:125:         y2 = y1;
	mov	r10, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:126:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled5.c:115:     for (; i < sample_count; i++) {
	add	r8, r8, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled5.c:115:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp261, sample_count
	cmp	r8, r3	@ i, tmp261
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled5.c:129:     return y1;
	mov	r3, r5	@ _131, y1
@ /home/student/seng440/filter/butterworth_unrolled5.c:130: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:157:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled5.c:160:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled5.c:162:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled5.c:175:     return 0;
	movs	r3, #0	@ _17,
.L15:
