...
@ /home/student/seng440/filter/butterworth_unrolled6.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled6.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:36:         register int input0 = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp262, x
	add	r3, r3, r2	@ _3, tmp262
@ /home/student/seng440/filter/butterworth_unrolled6.c:36:         register int input0 = x[i];
	ldr	r1, [r3]	@ input0, *_3
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:43:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled6.c:45:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp265, x
	add	r3, r3, r2	@ _22, tmp265
@ /home/student/seng440/filter/butterworth_unrolled6.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:56:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled6.c:58:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:62:         register int input2 = x[i + 2];
	mov	r3, r10	@ i.12_38, i
	adds	r3, r3, #2	@ _39, i.12_38,
	lsls	r3, r3, #2	@ _40, _39,
	ldr	r2, [r7, #4]	@ tmp268, x
	add	r3, r3, r2	@ _41, tmp268
@ /home/student/seng440/filter/butterworth_unrolled6.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:69:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled6.c:71:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp271, x
	add	r3, r3, r2	@ _60, tmp271
@ /home/student/seng440/filter/butterworth_unrolled6.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:82:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled6.c:84:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:88:         register int input4 = x[i + 4];
	...
	ldr	r2, [r7, #4]	@ tmp274, x
	add	r3, r3, r2	@ _79, tmp274
@ /home/student/seng440/filter/butterworth_unrolled6.c:88:         register int input4 = x[i + 4];
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:95:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:96:         x1 = input4;
	mov	r6, r1	@ x1, input4
@ /home/student/seng440/filter/butterworth_unrolled6.c:97:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:98:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:101:         register int input5 = x[i + 5];
	...
	ldr	r2, [r7, #4]	@ tmp277, x
	add	r3, r3, r2	@ _98, tmp277
@ /home/student/seng440/filter/butterworth_unrolled6.c:101:         register int input5 = x[i + 5];
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:108:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:109:         x1 = input5;
	mov	r6, r1	@ x1, input5
@ /home/student/seng440/filter/butterworth_unrolled6.c:110:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:111:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:34:     for (i = 0; i + 5 < sample_count; i += 6) {
	add	r10, r10, #6	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled6.c:34:     for (i = 0; i + 5 < sample_count; i += 6) {
	add	r3, r10, #5	@ _114, i,
@ /home/student/seng440/filter/butterworth_unrolled6.c:34:     for (i = 0; i + 5 < sample_count; i += 6) {
	ldr	r2, [r7]	@ tmp280, sample_count
	cmp	r2, r3	@ tmp280, _114
	bgt	.L5		@,
@ /home/student/seng440/filter/butterworth_unrolled6.c:115:     for (; i < sample_count; i++) {
	b	.L6		@
.L7:
@ /home/student/seng440/filter/butterworth_unrolled6.c:116:         register int current_input = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp281, x
	add	r3, r3, r2	@ _117, tmp281
@ /home/student/seng440/filter/butterworth_unrolled6.c:116:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_117
@ /home/student/seng440/filter/butterworth_unrolled6.c:117:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
	...
	mul	r2, r3, r1	@ _119, b02_1.37_118, current_input
@ /home/student/seng440/filter/butterworth_unrolled6.c:117:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:123:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled6.c:124:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled6.c:125:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:126:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled6.c:115:     for (; i < sample_count; i++) {
	add	r10, r10, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled6.c:115:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp284, sample_count
	cmp	r10, r3	@ i, tmp284
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled6.c:129:     return y1;
	mov	r3, r5	@ _150, y1
@ /home/student/seng440/filter/butterworth_unrolled6.c:130: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:157:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled6.c:160:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled6.c:162:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled6.c:175:     return 0;
	movs	r3, #0	@ _17,
.L15:
