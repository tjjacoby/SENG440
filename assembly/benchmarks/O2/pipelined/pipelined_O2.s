...
@ /home/student/seng440/filter/butterworth_pipelined.c:95: {
	subw	sp, sp, #1364	@,,
@ /home/student/seng440/filter/butterworth_pipelined.c:107:         x[n] = (int)(input * (1 << 14));
	add	r3, sp, #1360	@ tmp307,,
	add	r4, sp, #798720	@ _137,,
@ /home/student/seng440/filter/butterworth_pipelined.c:101:         double time = (double)n / SAMPLE_RATE;
	vldr.64	d11, .L14	@ tmp185,
@ /home/student/seng440/filter/butterworth_pipelined.c:103:         double input = INPUT_AMPLITUDE * sin(
	vldr.64	d10, .L14+8	@ tmp187,
@ /home/student/seng440/filter/butterworth_pipelined.c:103:         double input = INPUT_AMPLITUDE * sin(
	vldr.64	d9, .L14+16	@ tmp189,
@ /home/student/seng440/filter/butterworth_pipelined.c:107:         x[n] = (int)(input * (1 << 14));
	vldr.64	d8, .L14+24	@ tmp191,
@ /home/student/seng440/filter/butterworth_pipelined.c:107:         x[n] = (int)(input * (1 << 14));
	str	r3, [sp, #36]	@ tmp307, %sfp
	add	r3, sp, #80	@ tmp179,,
	str	r2, [r3]	@ tmp180, x[0]
	mov	r5, r3	@ ivtmp.18, tmp179
	addw	r4, r4, #1356	@ _137, _137,
	mov	r7, r3	@ ivtmp.30, ivtmp.18
.L2:
@ /home/student/seng440/filter/butterworth_pipelined.c:101:         double time = (double)n / SAMPLE_RATE;
	vmov	s15, r6	@ int	@ n, n
@ /home/student/seng440/filter/butterworth_pipelined.c:100:     for (int n = 0; n < N; n++) {
...
@ /home/student/seng440/filter/butterworth_pipelined.c:101:         double time = (double)n / SAMPLE_RATE;
	vdiv.f64	d0, d16, d11	@ _133, _132, tmp185
@ /home/student/seng440/filter/butterworth_pipelined.c:103:         double input = INPUT_AMPLITUDE * sin(
	vmul.f64	d0, d0, d10	@, _133, tmp187
	bl	sin(PLT)	@
@ /home/student/seng440/filter/butterworth_pipelined.c:103:         double input = INPUT_AMPLITUDE * sin(
	vmul.f64	d0, d0, d9	@ input_35, tmp309, tmp189
@ /home/student/seng440/filter/butterworth_pipelined.c:107:         x[n] = (int)(input * (1 << 14));
	vmul.f64	d0, d0, d8	@ _4, input_35, tmp191
@ /home/student/seng440/filter/butterworth_pipelined.c:107:         x[n] = (int)(input * (1 << 14));
	vcvt.s32.f64	s0, d0	@ tmp192, _4
	vmov	r3, s0	@ int	@ tmp192, tmp192
	str	r3, [r7, #4]!	@ tmp192, MEM[(int *)_139]
@ /home/student/seng440/filter/butterworth_pipelined.c:100:     for (int n = 0; n < N; n++) {
	cmp	r4, r7	@ _137, ivtmp.30
	bne	.L2		@,
@ /home/student/seng440/filter/butterworth_pipelined.c:113:     if (clock_gettime(CLOCK_MONOTONIC, &start) != 0) {
	ldr	r3, [sp, #36]	@ tmp307, %sfp
	movs	r0, #1	@,
	sub	r1, r3, #1312	@, tmp307,
...
@ /home/student/seng440/filter/butterworth_pipelined.c:118:     volatile int y = run_IIR(x, N);
	subw	r4, r1, #1316	@ tmp227, tmp307,
@ /home/student/seng440/filter/butterworth_pipelined.c:87:     y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	it	ne
	movne	r2, #1	@ _81,
@ /home/student/seng440/filter/butterworth_pipelined.c:120:     if (clock_gettime(CLOCK_MONOTONIC, &end) != 0) {
	sub	r6, r1, #1296	@ tmp228, tmp307,
@ /home/student/seng440/filter/butterworth_pipelined.c:87:     y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/seng440/filter/butterworth_pipelined.c:136:         (double)x[N - 1] / (1 << 14),
	ldr	r2, [sp, #36]	@ tmp307, %sfp
@ /home/student/seng440/filter/butterworth_pipelined.c:137:         (double)y / (1 << 14)
	vmov	s15, r3	@ int	@ y.0_13, y.0_13
@ /home/student/seng440/filter/butterworth_pipelined.c:28:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	movt	r0, 15258	@ tmp244,
@ /home/student/seng440/filter/butterworth_pipelined.c:136:         (double)x[N - 1] / (1 << 14),
	add	r1, r2, #794624	@ tmp281, tmp307,
@ /home/student/seng440/filter/butterworth_pipelined.c:129:     printf(
	vldr.64	d18, .L14+32	@ tmp275,
@ /home/student/seng440/filter/butterworth_pipelined.c:136:         (double)x[N - 1] / (1 << 14),
...
@ /home/student/seng440/filter/butterworth_pipelined.c:26:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	ldrd	r7, r1, [r6, #4]	@ tmp296, end.tv_nsec, tmp228,
@ /home/student/seng440/filter/butterworth_pipelined.c:25:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r6, [r2, #4]	@ tmp298, start.tv_sec
@ /home/student/seng440/filter/butterworth_pipelined.c:26:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	asr	r2, r1, #31	@ tmp257, end.tv_nsec,
@ /home/student/seng440/filter/butterworth_pipelined.c:25:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	sbc	r7, r7, r6	@ seconds_38, tmp296, tmp298
@ /home/student/seng440/filter/butterworth_pipelined.c:28:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	umull	r3, r6, r3, r0	@ _44, _44, seconds_38, tmp244
	mla	r6, r0, r7, r6	@ tmp250, tmp244, seconds_38, _44
@ /home/student/seng440/filter/butterworth_pipelined.c:26:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	subs	r0, r1, r4	@ nanoseconds_43, end.tv_nsec, start.tv_nsec
	sbc	r2, r2, r4, asr #31	@ nanoseconds_43, tmp257, start.tv_nsec,
@ /home/student/seng440/filter/butterworth_pipelined.c:28:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	adds	r4, r3, r0	@ _46, _44, nanoseconds_43
	adc	r6, r6, r2	@ _46, tmp250, nanoseconds_43
@ /home/student/seng440/filter/butterworth_pipelined.c:126:     double ns_per_sample = (double)elapsed_ns / (double)N;
	mov	r0, r4	@, _46
@ /home/student/seng440/filter/butterworth_pipelined.c:129:     printf(
	adr	r3, .L14+48	@,
	ldrd	r2, [r3]	@ tmp286,
	ldr	r7, .L14+56	@ tmp272,
@ /home/student/seng440/filter/butterworth_pipelined.c:126:     double ns_per_sample = (double)elapsed_ns / (double)N;
	mov	r1, r6	@, _46
@ /home/student/seng440/filter/butterworth_pipelined.c:129:     printf(
	strd	r2, [sp, #8]	@ tmp286,,
...
@ /home/student/seng440/filter/butterworth_pipelined.c:126:     double ns_per_sample = (double)elapsed_ns / (double)N;
	bl	__aeabi_ul2d(PLT)	@
	vmov	d18, r0, r1	@ tmp312,
@ /home/student/seng440/filter/butterworth_pipelined.c:126:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vldr.64	d17, .L14+40	@ tmp289,
@ /home/student/seng440/filter/butterworth_pipelined.c:129:     printf(
	mov	r1, #3392	@,
	mov	r2, r4	@, _46
	movt	r1, 3	@,
	mov	r3, r6	@, _46
@ /home/student/seng440/filter/butterworth_pipelined.c:126:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vdiv.f64	d16, d18, d17	@ ns_per_sample_26, tmp312, tmp289
@ /home/student/seng440/filter/butterworth_pipelined.c:129:     printf(
	mov	r0, r7	@ tmp272, tmp272
