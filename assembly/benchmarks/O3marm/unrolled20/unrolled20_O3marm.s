...
@ /home/student/seng440/filter/butterworth_unrolled20.c:311:     for (int n = 0; n < N; n++) {
	mov	r5, #1	@ n,
	add	r8, sp, r8	@ _1398,, _1398
@ /home/student/seng440/filter/butterworth_unrolled20.c:317:         x[n] = (int)(input * (1 << 14));
	add	r7, sp, #1360	@ tmp712,,
	mov	r4, r7	@ ivtmp.37, tmp712
...
@ /home/student/seng440/filter/butterworth_unrolled20.c:254:         y = ((y) + (a2 * y2));
	mla	lr, r2, r7, lr	@ y, tmp458, y, y
@ /home/student/seng440/filter/butterworth_unrolled20.c:263:         y = ((b02_1 * input18) + ((b02_1 << 1) * x1));
	mla	ip, r3, r9, ip	@ y, tmp450, x2, _365
@ /home/student/seng440/filter/butterworth_unrolled20.c:255:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	ubfx	r7, lr, #0, #14	@ _356, y,,
@ /home/student/seng440/filter/butterworth_unrolled20.c:255:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	subs	r7, r7, #0	@ _357, _356,
@ /home/student/seng440/filter/butterworth_unrolled20.c:264:         y = ((y) + (b02_1 * x2));
	add	ip, r10, ip	@ y, _330, y
@ /home/student/seng440/filter/butterworth_unrolled20.c:255:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	movne	r7, #1	@ _357,
@ /home/student/seng440/filter/butterworth_unrolled20.c:255:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	orr	r7, r7, lr, asr #14	@ y, _357, y,
...
@ /home/student/seng440/filter/butterworth_unrolled20.c:346:         (double)x[N - 1] / (1 << 14),
	movw	r2, #13644	@ tmp739,
	movt	r2, 12	@ tmp739,
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	mov	r1, #51712	@ tmp657,
@ /home/student/seng440/filter/butterworth_unrolled20.c:346:         (double)x[N - 1] / (1 << 14),
	add	r2, sp, r2	@ tmp739,, tmp739
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	vldr.64	d17, .L14+32	@ tmp682,
@ /home/student/seng440/filter/butterworth_unrolled20.c:346:         (double)x[N - 1] / (1 << 14),
	vldr.32	s15, [r2]	@ int	@ tmp740, x[199999]
@ /home/student/seng440/filter/butterworth_unrolled20.c:20:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r2, [r7, #-1312]	@ start.tv_sec, start.tv_sec
@ /home/student/seng440/filter/butterworth_unrolled20.c:346:         (double)x[N - 1] / (1 << 14),
	vcvt.f64.s32	d16, s15	@ _11, tmp740
@ /home/student/seng440/filter/butterworth_unrolled20.c:20:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r0, [r7, #-1292]	@ tmp701, end.tv_sec
	subs	r3, r3, r2	@ seconds_38, end.tv_sec, start.tv_sec
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	movt	r1, 15258	@ tmp657,
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	vmul.f64	d16, d16, d17	@ _12, _11, tmp682
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	umull	r3, r6, r3, r1	@ _44, _44, seconds_38, tmp657
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
...
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	vmul.f64	d16, d16, d17	@ _15, _14, tmp682
	vstr.64	d16, [sp, #24]	@ _15,
@ /home/student/seng440/filter/butterworth_unrolled20.c:20:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r2, [r7, #-1308]	@ tmp703, start.tv_sec
	sbc	r2, r0, r2	@ seconds_38, tmp701, tmp703
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	mla	r6, r1, r2, r6	@ tmp663, tmp657, seconds_38, _44
...
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	ldr	r7, .L14+40	@ tmp679,
@ /home/student/seng440/filter/butterworth_unrolled20.c:21:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	subs	r0, r1, r2	@ nanoseconds_43, end.tv_nsec, start.tv_nsec
@ /home/student/seng440/filter/butterworth_unrolled20.c:21:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	asr	r2, r2, #31	@ tmp673, start.tv_nsec,
@ /home/student/seng440/filter/butterworth_unrolled20.c:21:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	rsc	r2, r2, r1, asr #31	@ nanoseconds_43, tmp673, end.tv_nsec,
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	adds	r4, r3, r0	@ _46, _44, nanoseconds_43
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	movw	r3, #65529	@,
@ /home/student/seng440/filter/butterworth_unrolled20.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	adc	r6, r6, r2	@ _46, tmp663, nanoseconds_43
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	movw	r2, #17721	@ tmp691,
	movt	r2, 29255	@ tmp691,
...
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	strd	r2, [sp, #8]	@ tmp691,,
.LPIC2:
	add	r7, pc, r7	@ tmp679, tmp679
@ /home/student/seng440/filter/butterworth_unrolled20.c:336:     double ns_per_sample = (double)elapsed_ns / (double)N;
	bl	__aeabi_ul2d(PLT)	@
	vmov	d18, r0, r1	@ tmp717,
@ /home/student/seng440/filter/butterworth_unrolled20.c:336:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vldr.64	d17, .L17	@ tmp694,
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	mov	r1, #3392	@,
	mov	r2, r4	@, _46
	movt	r1, 3	@,
	mov	r3, r6	@, _46
@ /home/student/seng440/filter/butterworth_unrolled20.c:336:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vdiv.f64	d16, d18, d17	@ ns_per_sample_26, tmp717, tmp694
@ /home/student/seng440/filter/butterworth_unrolled20.c:339:     printf(
	mov	r0, r7	@ tmp679, tmp679
