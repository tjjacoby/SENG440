...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:132:         x[n] = (int)(input * (1 << 14));
	mov	r3, #0	@ tmp208,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:123: {
	sub	sp, sp, #12	@,,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:126:     for (int n = 0; n < N; n++) {
	mov	r6, #1	@ n,
	add	r8, sp, r8	@ _188,, _188
@ /home/student/ARM_TEST/butterworth_unrolled4.c:132:         x[n] = (int)(input * (1 << 14));
	add	r5, sp, #1344	@ tmp369,,
	add	r5, r5, #8	@ tmp369, tmp369,
	mov	r4, r5	@ ivtmp.22, tmp369
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:43:         y = __QADD(y, a1 * y1);
	movw	r7, #18727	@ tmp235,
.L5:
@ /home/student/ARM_TEST/butterworth_unrolled4.c:37:         register int input0 = x[i];
	ldr	r3, [r4]	@ input0, MEM[(const int *)_161]
@ /home/student/ARM_TEST/butterworth_unrolled4.c:38:         register int y = __QADD(
	mul	r9, r8, r0	@ _55, tmp229, x1
	mul	r10, ip, r3	@ _53, tmp226, input0
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r9, r10, r9	@ result, _53, _55
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:42:         y = __QADD(y, b02_1 * x2);
	.arm
	.syntax unified
	mul	lr, ip, lr	@ _58, tmp226, x2
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd lr, r9, lr	@ result, result, _58
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:43:         y = __QADD(y, a1 * y1);
	.arm
	.syntax unified
	mul	r9, r7, r2	@ _61, tmp235, y1
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd lr, lr, r9	@ result, result, _61
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:44:         y = __QADD(y, a2 * y2);
	.arm
	.syntax unified
	mul	r1, r6, r1	@ _64, tmp238, y2
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r1, lr, r1	@ result, result, _64
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:45:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	.arm
	.syntax unified
	ubfx	lr, r1, #0, #14	@ _67, result,,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:45:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	asr	r1, r1, #14	@ _66, result,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:54:         y = __QADD(
	mul	r3, r8, r3	@ _76, tmp229, input0
@ /home/student/ARM_TEST/butterworth_unrolled4.c:45:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	cmp	lr, #0	@ _67,
	orrne	r1, r1, #1	@,, y, _66
@ /home/student/ARM_TEST/butterworth_unrolled4.c:54:         y = __QADD(
	ldr	lr, [r4, #4]	@ tmp379, MEM[(const int *)_161 + 4B]
	mul	r9, ip, lr	@ _75, tmp226, tmp379
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r3, r9, r3	@ result, _75, _76
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:58:         y = __QADD(y, b02_1 * x2);
	.arm
	.syntax unified
	mul	r0, ip, r0	@ _78, tmp226, x1
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:70:         y = __QADD(
	ldmib	r4, {r2, lr}	@ ivtmp.22,,
	mul	r0, r8, r2	@ _94, tmp229, tmp380
	mul	r2, ip, lr	@ _93, tmp226, x2
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r2, r2, r0	@ result, _93, _94
@ 0 "" 2
@ 24 "./cmsis_compiler.h" 1
	qadd r2, r2, r10	@ result, result, _53
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:75:         y = __QADD(y, a1 * y1);
	.arm
	.syntax unified
	mul	r0, r7, r3	@ _97, tmp235, y
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r2, r2, r0	@ result, result, _97
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:76:         y = __QADD(y, a2 * y2);
	.arm
	.syntax unified
	mul	r1, r6, r1	@ _99, tmp238, y
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r1, r2, r1	@ result, result, _99
@ 0 "" 2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:77:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	.arm
	.syntax unified
	ubfx	r2, r1, #0, #14	@ _102, result,,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:85:         register int input3 = x[i + 3];
	ldr	r0, [r4, #12]	@ x1, MEM[(const int *)_161 + 12B]
@ /home/student/ARM_TEST/butterworth_unrolled4.c:77:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	asr	r1, r1, #14	@ _101, result,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:86:         y = __QADD(
	mul	r10, r8, lr	@ _111, tmp229, x2
@ /home/student/ARM_TEST/butterworth_unrolled4.c:77:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
	cmp	r2, #0	@ _102,
	orrne	r1, r1, #1	@,, y2, _101
@ /home/student/ARM_TEST/butterworth_unrolled4.c:86:         y = __QADD(
	mul	r2, ip, r0	@ _110, tmp226, x1
@ ./cmsis_compiler.h:24:     __asm__ volatile (
	.syntax divided
@ 24 "./cmsis_compiler.h" 1
	qadd r2, r2, r10	@ result, _110, _111
@ 0 "" 2
@ 24 "./cmsis_compiler.h" 1
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:35:     for (i = 0; i + 3 < sample_count; i += 4) {
	add	r4, r4, #16	@ ivtmp.22, ivtmp.22,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:93:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:145:     if (clock_gettime(CLOCK_MONOTONIC, &end) != 0) {
	sub	r1, r5, #1296	@, tmp369,
	mov	r0, #1	@,
	bl	__clock_gettime64(PLT)	@
@ /home/student/ARM_TEST/butterworth_unrolled4.c:145:     if (clock_gettime(CLOCK_MONOTONIC, &end) != 0) {
	subs	r6, r0, #0	@ <retval>, tmp373
	bne	.L13		@,
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:161:         (double)x[N - 1] / (1 << 14),
	movw	r2, #13636	@ tmp382,
	movt	r2, 12	@ tmp382,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:24:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	mov	r0, #51712	@ tmp314,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:161:         (double)x[N - 1] / (1 << 14),
	add	r2, sp, r2	@ tmp382,, tmp382
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	vldr.64	d17, .L14+32	@ tmp339,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:161:         (double)x[N - 1] / (1 << 14),
	vldr.32	s15, [r2]	@ int	@ tmp383, x[199999]
@ /home/student/ARM_TEST/butterworth_unrolled4.c:21:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r2, [r5, #-1312]	@ start.tv_sec, start.tv_sec
@ /home/student/ARM_TEST/butterworth_unrolled4.c:161:         (double)x[N - 1] / (1 << 14),
	vcvt.f64.s32	d16, s15	@ _11, tmp383
@ /home/student/ARM_TEST/butterworth_unrolled4.c:21:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r1, [r5, #-1292]	@ tmp358, end.tv_sec
	subs	r3, r3, r2	@ seconds_39, end.tv_sec, start.tv_sec
@ /home/student/ARM_TEST/butterworth_unrolled4.c:24:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	movt	r0, 15258	@ tmp314,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	vmul.f64	d16, d16, d17	@ _12, _11, tmp339
	ldr	r7, .L14+48	@ tmp336,
.LPIC2:
	add	r7, pc, r7	@ tmp336, tmp336
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	vmul.f64	d16, d16, d17	@ _15, _14, tmp339
	vstr.64	d16, [sp, #24]	@ _15,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:21:     int64_t seconds = (int64_t)end->tv_sec - (int64_t)start->tv_sec;
	ldr	r2, [r5, #-1308]	@ tmp360, start.tv_sec
	sbc	r2, r1, r2	@ seconds_39, tmp358, tmp360
@ /home/student/ARM_TEST/butterworth_unrolled4.c:24:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	umull	r3, r1, r3, r0	@ _45, _45, seconds_39, tmp314
	mla	r1, r0, r2, r1	@ tmp320, tmp314, seconds_39, _45
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:22:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	asr	r2, r2, #31	@ tmp330, start.tv_nsec,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:22:     int64_t nanoseconds = (int64_t)end->tv_nsec - (int64_t)start->tv_nsec;
	rsc	r2, r2, r0, asr #31	@ nanoseconds_44, tmp330, end.tv_nsec,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:24:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	adds	r4, r3, ip	@ _47, _45, nanoseconds_44
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	movw	r3, #65529	@,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:24:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	adc	r5, r1, r2	@ _47, tmp320, nanoseconds_44
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	movw	r2, #17721	@ tmp348,
	movt	r2, 29255	@ tmp348,
...
@ /home/student/ARM_TEST/butterworth_unrolled4.c:151:     double ns_per_sample = (double)elapsed_ns / (double)N;
	bl	__aeabi_ul2d(PLT)	@
	vmov	d18, r0, r1	@ tmp374,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:151:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vldr.64	d17, .L14+40	@ tmp351,
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	mov	r1, #3392	@,
	mov	r2, r4	@, _47
	movt	r1, 3	@,
	mov	r3, r5	@, _47
@ /home/student/ARM_TEST/butterworth_unrolled4.c:151:     double ns_per_sample = (double)elapsed_ns / (double)N;
	vdiv.f64	d16, d18, d17	@ ns_per_sample_26, tmp374, tmp351
@ /home/student/ARM_TEST/butterworth_unrolled4.c:154:     printf(
	mov	r0, r7	@ tmp336, tmp336
