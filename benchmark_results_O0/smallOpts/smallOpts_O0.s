...
@ /home/student/seng440/filter/butterworth_smallOpts.c:30:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_smallOpts.c:31: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_smallOpts.c:36:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_smallOpts.c:45:         register int y = ((b02_1 * x[i]) + ((b02_1 << 1) * x1));
	...
	ldr	r3, [r3]	@ _4, *_3
@ /home/student/seng440/filter/butterworth_smallOpts.c:45:         register int y = ((b02_1 * x[i]) + ((b02_1 << 1) * x1));
	movw	r2, #1105	@ b02_1.2_5,
	mul	r2, r3, r2	@ _6, _4, b02_1.2_5
@ /home/student/seng440/filter/butterworth_smallOpts.c:45:         register int y = ((b02_1 * x[i]) + ((b02_1 << 1) * x1));
	movw	r3, #1105	@ b02_1.3_7,
	lsls	r3, r3, #1	@ _8, b02_1.3_7,
@ /home/student/seng440/filter/butterworth_smallOpts.c:45:         register int y = ((b02_1 * x[i]) + ((b02_1 << 1) * x1));
	mul	r3, r6, r3	@ _9, x1, _8
@ /home/student/seng440/filter/butterworth_smallOpts.c:45:         register int y = ((b02_1 * x[i]) + ((b02_1 << 1) * x1));
	adds	r4, r2, r3	@ y, _6, _9
@ /home/student/seng440/filter/butterworth_smallOpts.c:46:         y = ((y) + (b02_1 * x2));
	movw	r3, #1105	@ b02_1.4_10,
	mul	r3, r3, r9	@ _11, b02_1.4_10, x2
@ /home/student/seng440/filter/butterworth_smallOpts.c:46:         y = ((y) + (b02_1 * x2));
	add	r4, r4, r3	@ y, _11
@ /home/student/seng440/filter/butterworth_smallOpts.c:47:         y = ((y) + (a1 * y1));
	movw	r3, #18727	@ a1.5_12,
	mul	r3, r3, r8	@ _13, a1.5_12, y1
@ /home/student/seng440/filter/butterworth_smallOpts.c:47:         y = ((y) + (a1 * y1));
	add	r4, r4, r3	@ y, _13
@ /home/student/seng440/filter/butterworth_smallOpts.c:48:         y = ((y) + (a2 * y2));
	movw	r3, #58773	@ a2.6_14,
	movt	r3, 65535	@ a2.6_14,
	mul	r3, r3, r10	@ _15, a2.6_14, y2
@ /home/student/seng440/filter/butterworth_smallOpts.c:48:         y = ((y) + (a2 * y2));
	add	r4, r4, r3	@ y, _15
...
@ /home/student/seng440/filter/butterworth_smallOpts.c:54:         x2 = x1;
	mov	r9, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_smallOpts.c:55:         x1 = x[i];
	mov	r3, r5	@ i.7_20, i
	lsls	r3, r3, #2	@ _21, i.7_20,
	ldr	r2, [r7, #4]	@ tmp147, x
	add	r3, r3, r2	@ _22, tmp147
@ /home/student/seng440/filter/butterworth_smallOpts.c:55:         x1 = x[i];
	ldr	r6, [r3]	@ x1, *_22
@ /home/student/seng440/filter/butterworth_smallOpts.c:57:         y2 = y1;
	mov	r10, r8	@ y2, y1
@ /home/student/seng440/filter/butterworth_smallOpts.c:58:         y1 = y;
	mov	r8, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_smallOpts.c:43:     for (i = 0; i < sample_count; i++) {
	adds	r5, r5, #1	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_smallOpts.c:43:     for (i = 0; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp148, sample_count
	cmp	r5, r3	@ i, tmp148
	blt	.L5		@,
@ /home/student/seng440/filter/butterworth_smallOpts.c:60:     return y1;
	mov	r3, r8	@ _35, y1
@ /home/student/seng440/filter/butterworth_smallOpts.c:61: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_smallOpts.c:93:         return 1;
	...
	b	.L13		@
.L12:
@ /home/student/seng440/filter/butterworth_smallOpts.c:96:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_smallOpts.c:98:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L14+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_smallOpts.c:111:     return 0;
	movs	r3, #0	@ _17,
.L13:
