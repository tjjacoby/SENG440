...
@ /home/student/seng440/filter/butterworth_unrolled8.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled8.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:36:         register int input0 = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp302, x
	add	r3, r3, r2	@ _3, tmp302
@ /home/student/seng440/filter/butterworth_unrolled8.c:36:         register int input0 = x[i];
	ldr	r1, [r3]	@ input0, *_3
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:43:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled8.c:45:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp305, x
	add	r3, r3, r2	@ _22, tmp305
@ /home/student/seng440/filter/butterworth_unrolled8.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:56:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled8.c:58:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:62:         register int input2 = x[i + 2];
	...
	ldr	r2, [r7, #4]	@ tmp308, x
	add	r3, r3, r2	@ _41, tmp308
@ /home/student/seng440/filter/butterworth_unrolled8.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:69:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled8.c:71:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp311, x
	add	r3, r3, r2	@ _60, tmp311
@ /home/student/seng440/filter/butterworth_unrolled8.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:82:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled8.c:84:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:88:         register int input4 = x[i + 4];
	...
	ldr	r2, [r7, #4]	@ tmp314, x
	add	r3, r3, r2	@ _79, tmp314
@ /home/student/seng440/filter/butterworth_unrolled8.c:88:         register int input4 = x[i + 4];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:95:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:96:         x1 = input4;
	mov	r6, r1	@ x1, input4
@ /home/student/seng440/filter/butterworth_unrolled8.c:97:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:98:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:101:         register int input5 = x[i + 5];
	...
	ldr	r2, [r7, #4]	@ tmp317, x
	add	r3, r3, r2	@ _98, tmp317
@ /home/student/seng440/filter/butterworth_unrolled8.c:101:         register int input5 = x[i + 5];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:108:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:109:         x1 = input5;
	mov	r6, r1	@ x1, input5
@ /home/student/seng440/filter/butterworth_unrolled8.c:110:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:111:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:114:         register int input6 = x[i + 6];
	...
	ldr	r2, [r7, #4]	@ tmp320, x
	add	r3, r3, r2	@ _117, tmp320
@ /home/student/seng440/filter/butterworth_unrolled8.c:114:         register int input6 = x[i + 6];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:121:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:122:         x1 = input6;
	mov	r6, r1	@ x1, input6
@ /home/student/seng440/filter/butterworth_unrolled8.c:123:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:124:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:127:         register int input7 = x[i + 7];
	...
	ldr	r2, [r7, #4]	@ tmp323, x
	add	r3, r3, r2	@ _136, tmp323
@ /home/student/seng440/filter/butterworth_unrolled8.c:127:         register int input7 = x[i + 7];
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:134:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:135:         x1 = input7;
	mov	r6, r1	@ x1, input7
@ /home/student/seng440/filter/butterworth_unrolled8.c:136:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:137:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:34:     for (i = 0; i + 7 < sample_count; i += 8) {
	add	r10, r10, #8	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled8.c:34:     for (i = 0; i + 7 < sample_count; i += 8) {
	add	r3, r10, #7	@ _152, i,
@ /home/student/seng440/filter/butterworth_unrolled8.c:34:     for (i = 0; i + 7 < sample_count; i += 8) {
	ldr	r2, [r7]	@ tmp326, sample_count
	cmp	r2, r3	@ tmp326, _152
	bgt	.L5		@,
@ /home/student/seng440/filter/butterworth_unrolled8.c:141:     for (; i < sample_count; i++) {
	b	.L6		@
.L7:
@ /home/student/seng440/filter/butterworth_unrolled8.c:142:         register int current_input = x[i];
	mov	r3, r10	@ i.48_153, i
	lsls	r3, r3, #2	@ _154, i.48_153,
	ldr	r2, [r7, #4]	@ tmp327, x
	add	r3, r3, r2	@ _155, tmp327
@ /home/student/seng440/filter/butterworth_unrolled8.c:142:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_155
@ /home/student/seng440/filter/butterworth_unrolled8.c:143:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
	movw	r3, #1105	@ b02_1.49_156,
	mul	r2, r3, r1	@ _157, b02_1.49_156, current_input
@ /home/student/seng440/filter/butterworth_unrolled8.c:143:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:144:         y = ((y) + (b02_1 * x2));
	movw	r3, #1105	@ b02_1.51_161,
	mul	r3, r3, r8	@ _162, b02_1.51_161, x2
@ /home/student/seng440/filter/butterworth_unrolled8.c:144:         y = ((y) + (b02_1 * x2));
	add	r4, r4, r3	@ y, _162
@ /home/student/seng440/filter/butterworth_unrolled8.c:145:         y = ((y) + (a1 * y1));
	movw	r3, #18727	@ a1.52_163,
	mul	r3, r5, r3	@ _164, y1, a1.52_163
@ /home/student/seng440/filter/butterworth_unrolled8.c:145:         y = ((y) + (a1 * y1));
	add	r4, r4, r3	@ y, _164
@ /home/student/seng440/filter/butterworth_unrolled8.c:146:         y = ((y) + (a2 * y2));
	movw	r3, #58773	@ a2.53_165,
	movt	r3, 65535	@ a2.53_165,
	mul	r3, r3, r9	@ _166, a2.53_165, y2
@ /home/student/seng440/filter/butterworth_unrolled8.c:146:         y = ((y) + (a2 * y2));
	add	r4, r4, r3	@ y, _166
@ /home/student/seng440/filter/butterworth_unrolled8.c:147:         y = (y >> 14) | ((y & ((1 << 14) - 1)) != 0);
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:149:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled8.c:150:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled8.c:151:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:152:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled8.c:141:     for (; i < sample_count; i++) {
	add	r10, r10, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled8.c:141:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp330, sample_count
	cmp	r10, r3	@ i, tmp330
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled8.c:155:     return y1;
	mov	r3, r5	@ _188, y1
@ /home/student/seng440/filter/butterworth_unrolled8.c:156: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:183:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled8.c:186:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled8.c:188:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled8.c:201:     return 0;
	movs	r3, #0	@ _17,
.L15:
