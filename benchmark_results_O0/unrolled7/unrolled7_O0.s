...
@ /home/student/seng440/filter/butterworth_unrolled7.c:23:     return (uint64_t)(seconds * 1000000000LL + nanoseconds);
	ldrd	r2, [r7, #16]	@ _14,,
@ /home/student/seng440/filter/butterworth_unrolled7.c:24: }
	mov	r0, r2	@, <retval>
	mov	r1, r3	@, <retval>
	adds	r7, r7, #48	@,,
	mov	sp, r7	@,
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:28:     register int x1 = 0;
	movs	r6, #0	@ x1,
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:36:         register int input0 = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp282, x
	add	r3, r3, r2	@ _3, tmp282
@ /home/student/seng440/filter/butterworth_unrolled7.c:36:         register int input0 = x[i];
	ldr	r1, [r3]	@ input0, *_3
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:43:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:44:         x1 = input0;
	mov	r6, r1	@ x1, input0
@ /home/student/seng440/filter/butterworth_unrolled7.c:45:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:46:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:49:         register int input1 = x[i + 1];
	...
	ldr	r2, [r7, #4]	@ tmp285, x
	add	r3, r3, r2	@ _22, tmp285
@ /home/student/seng440/filter/butterworth_unrolled7.c:49:         register int input1 = x[i + 1];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:56:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:57:         x1 = input1;
	mov	r6, r1	@ x1, input1
@ /home/student/seng440/filter/butterworth_unrolled7.c:58:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:59:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:62:         register int input2 = x[i + 2];
	mov	r3, r10	@ i.12_38, i
	adds	r3, r3, #2	@ _39, i.12_38,
	lsls	r3, r3, #2	@ _40, _39,
	ldr	r2, [r7, #4]	@ tmp288, x
	add	r3, r3, r2	@ _41, tmp288
@ /home/student/seng440/filter/butterworth_unrolled7.c:62:         register int input2 = x[i + 2];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:69:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:70:         x1 = input2;
	mov	r6, r1	@ x1, input2
@ /home/student/seng440/filter/butterworth_unrolled7.c:71:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:72:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:75:         register int input3 = x[i + 3];
	...
	ldr	r2, [r7, #4]	@ tmp291, x
	add	r3, r3, r2	@ _60, tmp291
@ /home/student/seng440/filter/butterworth_unrolled7.c:75:         register int input3 = x[i + 3];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:82:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:83:         x1 = input3;
	mov	r6, r1	@ x1, input3
@ /home/student/seng440/filter/butterworth_unrolled7.c:84:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:85:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:88:         register int input4 = x[i + 4];
	...
	ldr	r2, [r7, #4]	@ tmp294, x
	add	r3, r3, r2	@ _79, tmp294
@ /home/student/seng440/filter/butterworth_unrolled7.c:88:         register int input4 = x[i + 4];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:95:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:96:         x1 = input4;
	mov	r6, r1	@ x1, input4
@ /home/student/seng440/filter/butterworth_unrolled7.c:97:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:98:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:101:         register int input5 = x[i + 5];
	...
	ldr	r2, [r7, #4]	@ tmp297, x
	add	r3, r3, r2	@ _98, tmp297
@ /home/student/seng440/filter/butterworth_unrolled7.c:101:         register int input5 = x[i + 5];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:108:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:109:         x1 = input5;
	mov	r6, r1	@ x1, input5
@ /home/student/seng440/filter/butterworth_unrolled7.c:110:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:111:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:114:         register int input6 = x[i + 6];
	...
	ldr	r2, [r7, #4]	@ tmp300, x
	add	r3, r3, r2	@ _117, tmp300
@ /home/student/seng440/filter/butterworth_unrolled7.c:114:         register int input6 = x[i + 6];
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:121:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:122:         x1 = input6;
	mov	r6, r1	@ x1, input6
@ /home/student/seng440/filter/butterworth_unrolled7.c:123:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:124:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:34:     for (i = 0; i + 6 < sample_count; i += 7) {
	add	r10, r10, #7	@ i, i,
.L4:
@ /home/student/seng440/filter/butterworth_unrolled7.c:34:     for (i = 0; i + 6 < sample_count; i += 7) {
	add	r3, r10, #6	@ _133, i,
@ /home/student/seng440/filter/butterworth_unrolled7.c:34:     for (i = 0; i + 6 < sample_count; i += 7) {
	ldr	r2, [r7]	@ tmp303, sample_count
	cmp	r2, r3	@ tmp303, _133
	bgt	.L5		@,
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:129:         register int current_input = x[i];
	...
	ldr	r2, [r7, #4]	@ tmp304, x
	add	r3, r3, r2	@ _136, tmp304
@ /home/student/seng440/filter/butterworth_unrolled7.c:129:         register int current_input = x[i];
	ldr	r1, [r3]	@ current_input, *_136
@ /home/student/seng440/filter/butterworth_unrolled7.c:130:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
	...
	mul	r2, r3, r1	@ _138, b02_1.43_137, current_input
@ /home/student/seng440/filter/butterworth_unrolled7.c:130:         register int y = ((b02_1 * current_input) + ((b02_1 << 1) * x1));
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:136:         x2 = x1;
	mov	r8, r6	@ x2, x1
@ /home/student/seng440/filter/butterworth_unrolled7.c:137:         x1 = current_input;
	mov	r6, r1	@ x1, current_input
@ /home/student/seng440/filter/butterworth_unrolled7.c:138:         y2 = y1;
	mov	r9, r5	@ y2, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:139:         y1 = y;
	mov	r5, r4	@ y1, y
@ /home/student/seng440/filter/butterworth_unrolled7.c:128:     for (; i < sample_count; i++) {
	add	r10, r10, #1	@ i, i,
.L6:
@ /home/student/seng440/filter/butterworth_unrolled7.c:128:     for (; i < sample_count; i++) {
	ldr	r3, [r7]	@ tmp307, sample_count
	cmp	r10, r3	@ i, tmp307
	blt	.L7		@,
@ /home/student/seng440/filter/butterworth_unrolled7.c:142:     return y1;
	mov	r3, r5	@ _169, y1
@ /home/student/seng440/filter/butterworth_unrolled7.c:143: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #12	@,,
	mov	sp, r7	@,
	@ sp needed	@
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:170:         return 1;
	...
	b	.L15		@
.L14:
@ /home/student/seng440/filter/butterworth_unrolled7.c:173:     uint64_t elapsed_ns = elapsed_nanoseconds(&start, &end);
...
@ /home/student/seng440/filter/butterworth_unrolled7.c:175:     double final_time = (double)(N - 1) / SAMPLE_RATE;
	adr	r3, .L16+40	@,
	ldrd	r2, [r3]	@ tmp163,
...
.LPIC2:
	add	r0, pc	@ tmp178
	bl	printf(PLT)	@
@ /home/student/seng440/filter/butterworth_unrolled7.c:188:     return 0;
	movs	r3, #0	@ _17,
.L15:
